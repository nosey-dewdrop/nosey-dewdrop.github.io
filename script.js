...
const P=[
  ...
  {e:"🎵",n:"Musical Improvisation Tool",tg:"scale identifier & composition aid — deployed",
   d:"Identifies all possible musical scales from a few notes you play or hear, then suggests <strong>compatible triad chords</strong> for improvisation and composition. Built with a <strong>custom music theory algorithm</strong> that maps note combinations to scales across all modes — Phrygian, Dorian, Mixolydian, you name it. Features piano and guitar tab interfaces with dark/light mode. Designed for musicians who want to compose or jam fluently: <em>hear a riff like Sails of Charon by Scorpions, punch in the notes, get B Phrygian instantly, know all the triads.</em> Comes with detailed music theory documentation from <strong>MSC110 at Bilkent</strong>.",
